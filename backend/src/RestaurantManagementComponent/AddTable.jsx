...
const AddTable = () => {
  ...
  const [addTableRequest, setAddTableRequest] = useState(initialRequest);
  ...
  const saveTable = (e) => {
    fetch("http://localhost:8080/api/table/add", {
      method: "POST",
      headers: {
      ...
      <div className="mt-5 d-flex aligns-items-center justify-content-center">
        <div className="form-card border-color mb-2" style={{ width: "25rem" }}>
          <div className="container-fluid">
            ...
            >
              <h4 className="card-title">Add Restaurant Table</h4>
            </div>
